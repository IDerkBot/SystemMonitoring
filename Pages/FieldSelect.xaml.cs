    ...
    public partial class FieldSelect : Page
    {
        ...
        void Next_Click(object sender, RoutedEventArgs e) {
            ...
            else
            {
                ...
                seed = dbMonitoringEntities.gc().Seedings.Where(x => x.IdField == seed.IdField).Single();
            }
        ...
        void AddField_Click(object sender, RoutedEventArgs e) { ManagerPage.Page.Navigate(new Pages.AddField(CBDistrict.SelectedItem.ToString())); }
